...
const AI_PERSONAS = [
  ...
  { key: 'team_lead', label: 'Team Lead', icon: Briefcase },
];
          ...
          if (data.feedbacks && data.feedbacks.length > 0) {
            const aiMessages = data.feedbacks.map((fb, idx) => {
              ...
              return {
                ...
                text: fb.feedback,
                createdAt: new Date().toISOString(),
                author: { _id: 'ai-assistant', name: `AI · ${persona?.label || fb.persona}` },
                isAI: true,
                      ...
                      <div key={msg._id} className={styles['insight-card']}>
                        <div className={styles['insight-card-header']}>
                          ...
                          <span className={styles['insight-card-author']}
                            style={{ color: msg.anonymous ? undefined : getColor(msg.author?.name) }}
                          >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          {!isMine && (
                            <div
                              className={`${styles['message-author']} ${isAI ? styles['message-author--ai'] : ''}`}
                              style={{ color: (!isAI && !msg.anonymous) ? getColor(msg.author?.name) : undefined }}
                            >
                        ...
                        {AI_PERSONAS.map((p) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className={styles['ai-dropdown-icon']}>
